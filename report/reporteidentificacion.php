...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Ln(10);
		$this->Cell(60);
		$this->Cell(70,0,'REPORTE DE TIPOS DE IDENTIFICACIÓN',0,1,'C');
		$this->Ln(12);
...
if(count($users)>0)
{
	foreach($users as $user)
	{
		...
		$pdf->Cell(25,8,$user->idTipo,1,0,'C');			
		$pdf->Cell(80,8,iconv('UTF-8', 'windows-1252',$user->DesTipo),1,1,'L');
		$vordinal++;
	}
}
$pdf->SetFont('Arial','B',12);
$pdf->Multicell(0,8,'Total Tipos de Identificación: '.count($users));
...
$pdf->Output("ReporteIdentificaciones.pdf","I");
?>