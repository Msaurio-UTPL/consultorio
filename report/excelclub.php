...
require_once 'functions/getAllJugadoresClub.php';
...
$vliga=$_POST["vliga"];
$vclub=$_POST["vclub"];
if( isset($vliga) and isset($vclub))
{
	$informe = array();
	$row = array();
	$informe = getAllJugadoresClub($vliga,$vclub);
	$i = 2;
	$blanco='';
	if (count($informe)>0)
	{
...
$objPHPExcel->getActiveSheet()->setTitle('Listado de Jugadores');
$objPHPExcel->setActiveSheetIndex(0);
getHeaders($vliga."-".$vclub);
