...
if(Session::getUID()!="")
{
	...
	<div class="row">
		<div class="col-md-12">
		<h3>Seleccione Concepto</h3>
		<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=detalleconceptosg" role="form">
			...
			<div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">
					<button type="submit" class="btn btn-primary">Ver Detalle de Conceptos</button>
				</div>
			</div>
		</form>
		</div>
