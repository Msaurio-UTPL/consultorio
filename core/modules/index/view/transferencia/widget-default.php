...
if(Session::getUID()!="")
{
	...
	?>	
		<div class="row">
			...
			<h3>Transferencia de Jugadores</h3>
		</div>
			...
			$(document).ready(function(){
				$("#vnliga").change(function ()
				{
					$("#vnliga option:selected").each(function ()
					{
						...
						vurl='/sysplay/index.php?view=transferencia&q='+document.getElementById("vcod").value+'&vnliga=';
						//alert(vurl);
		...
		if (isset($_GET['vnliga']))
		{
			...
			<div class="row">
				<div class="col-md-12">
				<form class="form-horizontal" method="post" id="detalle" action="index.php?view=actualizajugadortrans" role="form">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label">Nueva Liga:*</label>
						<div class="col-lg-6">
					...
					<div class="form-group">
						<label for="inputEmail1" class="col-lg-2 control-label">Nuevo equipo:*</label>
						<div class="col-lg-6">
					...
					<div class="form-group">
						...
						<div class="col-lg-4">
							<select name="tipo" class="form-control" required>
								<option value="">-- Seleccione --</option>
								<option value="Préstamo campeonato">Préstamo campeonato</option>
								<option value="Préstamo Anual">Préstamo Anual</option>
								<option value="Pase Definitivo">Pase Definitivo</option>
							</select>
						</div>
					</div>
