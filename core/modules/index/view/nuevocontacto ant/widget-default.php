...
if(Session::getUID()!="")
{
	...
	?>
		<?php
			//echo $_GET["id"];
			$con = SPContacto::getById($_GET["id"],$_GET["id2"]);
			$tipo = SPDetConceptos::getByConReg("6",$con->detIdContacto);
			$pac = SPBasica::getInfoByIdSec($con->paciente_pacIdPaciente);			
			if (count($con)>0)
			{
				...
				<div class="row">
				<div class="col-md-12">
					<h3>Edición de Contactos:</h3>
					<form class="form-horizontal" method="post" id="addcontacto" action="index.php?view=anadircontacto" role="form">
					<div class="form-group">
						<label for="inputEmail1" class="col-lg-2 control-label">Paciente:</label>
						<div class="col-md-3">
							<input type="text" readonly name="id" class="form-control" value="<?php echo $pac->pacApellidos; echo " "; echo $pac->pacNombres; ?>" id="id" placeholder="Paciente">
						</div>
					</div>		
					<div class="form-group">
