	...
	?>	
		...
		<div class="col-md-12">
			...
			<form class="form-horizontal" role="form">
				<input type="hidden" name="view" value="consultanombre">
				<div class="form-group">
					<div class="col-lg-4">
						<div class="input-group">
						  <span class="input-group-addon"><i class="fa fa-search"></i></span>
						  <input type="text" name="q" value="<?php if(isset($_GET["q"]) && $_GET["q"]!=""){ echo $_GET["q"]; } ?>" required  class="form-control" placeholder="Nombres y Apellidos completos">
						</div>
					</div>
			...
			if( isset($_GET["q"]) )
			{
				$users = SPJugador::getByNombre($_GET['q']);
			}
			if(count($users)>0)
			{
				...
				<td><b>Creación:</b><br><?php echo $users->creacion; ?><br>
					<b>Fichaje:</b><br><?php echo $users->fichaje; ?></td>
				<td>
				...
				<!--
					<td style="width:30px;"><a href="index.php?view=editajugador&id=<?php echo $user->codigojugador;?>" class="btn btn-warning btn-xs">Edición</a></td>
				-->
				</tr>
				</table>
			...
			{		
				echo "<p class='alert alert-danger'><b>ATENCIÓN:</b> No hay Jugadores con los nombres y apellidos ingresados.</p>";
			}
			?>
			</table>
		</div>
