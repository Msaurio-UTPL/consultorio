...
if(Session::getUID()!="")
{
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a href="index.php?view=persona" class="btn btn-default pull-right"><i class='glyphicon glyphicon-edit'></i> Nuevo Paciente</a>
				...
				if(count($paciente)>0)
				{
					...
					foreach($paciente as $pac){ ?>
						...
						<td style="width:30px;"><a href="index.php?view=editapersona&id=<?php echo $pac->pacIdPaciente?>" class="btn btn-warning btn-xs">Edición</a></td>
						<td style="width:30px;"><a href="index.php?view=contacto&id=<?php echo $pac->pacIdPaciente?>" class="btn btn-warning btn-xs">Contactos</a></td>
						<td style="width:30px;"><a href="index.php?view=direccion&id=<?php echo $pac->pacIdPaciente?>" class="btn btn-warning btn-xs">Direcciones</a></td>
						<td style="width:30px;"><a href="index.php?view=citas1&id=<?php echo $pac->pacIdPaciente?>" class="btn btn-warning btn-xs">Agendar Cita</a></td>
						</tr>
					</table>
					<?php
					}
