		...
		<script language="javascript">
			$(document).ready(function(){
				$("#vliga").change(function ()
				{
					...
					{
						idliga = $(this).val();
						vurl='/sysplay/index.php?view=menuexcel&vliga=';
						//alert (idliga);
		...
		switch ($perfil)
		{
			case "1":
						...
						if (isset($_GET['vliga']))
						{
							...
							<div class="row">
								<div class="col-md-12">
								<h4>Exportar por Liga / Club</h4>
								<form class="form-horizontal" method="post" id="reporteclub" action="report/excelclub.php" role="form">
						...
						else
						{
							...
							<div class="row">
								<div class="col-md-12">
								<h4>Exportar por Liga / Club</h4>
								<form class="form-horizontal" method="post" id="reporteclub" action="report/reportejugadorclub.php" role="form">
									<div class="form-group">
										<label class="col-lg-2 control-label">Ligas disponibles:*</label>
										<div class="col-lg-6">
											<select name="vliga" id="vliga" class="form-control" required>
